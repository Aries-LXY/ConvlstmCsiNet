...
for period in range(int(1500 / test_peroid)):
    ...
    path = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/TensorBoard_' + file + '.csv'
    ...
    # save
    # save and print loss
    filename = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/trainLoss_' + file + '.csv'
    ...
    filename = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/valLoss_' + file + '.csv'
    ...
    picfile_loss = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/Loss_' + file + '.png'
    plt.savefig(picfile_loss)

    # serialize model to JSON
    model_json = autoencoder.to_json()
    outfile = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/model_' + file + '.json'
    with open(outfile, "w") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    outfile = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/model_' + file + '.h5'
    ...
    filename = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/rho' + file + '.csv'
    ...
    plt.ylabel('ρ')
    plt.legend(loc="upper right")
    picfile_rho = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/rho_' + file + '.png'
    plt.savefig(picfile_rho)

    # print nmse
    nmse_all = np.append(nmse_all, minus_nmse)
    nmse_all = np.reshape(nmse_all, (-1,))
    filename = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/nmse_' + file + '.csv'
    ...
    plt.ylabel('nmse')
    plt.legend(loc="upper right")
    picfile_nmse = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/nmse_' + file + '.png'
    ...
    for i in range(n):
        ...
        ax.get_yaxis().set_visible(False)
        ax.invert_yaxis()
    picfile = 'CSI/result' + '/ConvlstmCsiNet_' + envir + '/dim_' + str(encoded_dim) + '/pic_' + file + '.png'
    plt.savefig(picfile)
